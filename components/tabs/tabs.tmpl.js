...
;pug_debug_line = 4;pug_debug_filename = "components\u002Ftabs\u002Ftabs.tmpl.pug";
...
pug_html = pug_html + (pug_escape(null == (pug_interp = item.title) ? "" : pug_interp)) + "\u003C\u002Flabel\u003E";
  break;
default:
;pug_debug_line = 7;pug_debug_filename = "components\u002Ftabs\u002Ftabs.tmpl.pug";
...
pug_html = pug_html + "\u003Ci class=\"fa fa-plus-square\" aria-hidden=\"true\"\u003E\u003C\u002Fi\u003E\u003C\u002Flabel\u003E";}.call(this,"indexDisplayTab" in locals_for_with?locals_for_with.indexDisplayTab:typeof indexDisplayTab!=="undefined"?indexDisplayTab:undefined,"items" in locals_for_with?locals_for_with.items:typeof items!=="undefined"?items:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}