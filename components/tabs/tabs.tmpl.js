...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function tabsTmpl(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {var pug_debug_sources = {"components\u002Ftabs\u002Ftabs.tmpl.pug":"each item, index in this._data\n  case index\n    when 0\n      input(id=index type=\"radio\" name=\"list\" checked)\n      label(for=index title=item.title)=item.title\n    default\n      input(id=index type=\"radio\" name=\"list\")\n      label(for=index title=item.title)=item.title\ninput(id=\"tab__add\" type=\"radio\" name=\"list__add\")\nlabel(for=\"tab__add\")\n  i(class=\"fa fa-plus-square\" aria-hidden=\"true\")\n\n\n"};
;pug_debug_line = 1;pug_debug_filename = "components\u002Ftabs\u002Ftabs.tmpl.pug";
// iterate this._data
;(function(){
  var $$obj = this._data;
...
pug_html = pug_html + "\u003Ci class=\"fa fa-plus-square\" aria-hidden=\"true\"\u003E\u003C\u002Fi\u003E\u003C\u002Flabel\u003E";} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}