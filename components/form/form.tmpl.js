function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function formTmpl(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {var pug_debug_sources = {"components\u002Fform\u002Fform.tmpl.pug":"form.form\n  h1.form__title Добавить позицию\n  input.form__input(name=\"url\" placeholder=\"url\" type=\"text\" required)\n  input.form__input(name=\"anchor\" placeholder=\"anchor\" type=\"text\" required)\n  textarea.form__input(name=\"details\" placeholder=\"details\" rows=\"5\" required)\n  button.form__button(type=\"submit\") Добавить\n"};
...
pug_html = pug_html + "\u003Ctextarea class=\"form__input\" name=\"details\" placeholder=\"details\" rows=\"5\" required=\"required\"\u003E\u003C\u002Ftextarea\u003E";
